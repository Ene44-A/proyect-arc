...
<body>
    <section class="container p-4">
       ...
       /*  $ruta = $_GET['route-selected'];
        ...
        <form action="V_info-reserveUser.php">
            <div class="container">
                <div class="card p-4">
                    <h1>Informacion de su reserva</h1>
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input
                                        ...
                                        placeholder="<?php echo $name = $_GET['nombre']?>"
                                        autocomplete="off"
                                        required
                                        readonly
                                        readonly>
                            ...
                            <div class="col-12 mt-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input
                                        ...
                                        placeholder="<?php echo $_GET['telefono']?>"
                                        autocomplete="off"
                                        required
                                        readonly>
                                </div>
                            ...
                            <div class="col-12 mt-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input
                                        ...
                                        placeholder="<?php echo $_GET['fechaN']?>"
                                        autocomplete="off"
                                        required
                                        readonly>
                                </div>
                            ...
                            <div class="col-12 mt-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input
                                        ...
                                        placeholder="<?php echo $_SESSION['tbl_usuario'] ?>"
                                        autocomplete="off"
                                        value="<?php echo $_SESSION['tbl_usuario'] ?>"
                                        readonly>
                                </div>
                            </div>
                            <div class="col-12 mt-2">
                                <label>Asientos reservados<span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <div class="input-group-text"><i class="bi bi-person-fill"></i>
                                    </div>
                                    <input
                                        ...
                                        id="correo_usuario"
                                        name="asientos"
                                        placeholder="<?php echo $_GET['asientosR']?>"
                                        autocomplete="off"
                                        min="1"
                                        readonly>
                                </div>
